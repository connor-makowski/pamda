...
expected = {'a': {'b': [{'x_1': 'a', 'x_2': 'b'}, {'x_1': 'a', 'x_2': 'b'}], 'e': [{'x_1': 'a', 'x_2': 'e'}]}}
out = pamda.nestItem(
    path_keys=['x_1','x_2'],
    data=data
)
...
# pathOr
data={'a':{'b':1}}
if pamda.pathOr(default=2, path=['a','b'], data=data) != 1 or pamda.pathOr(default=2, path=['a','c'], data=data) != 2:
    print('pathOr failed')
...
if pamda.pipe(fns=[pamda.head, pamda.tail], args=(data,), kwargs={}) != 'c':
    print('pipe failed (1)')
if pamda.pipe(fns=[pamda.head, pamda.tail], args=(), kwargs={'data':data}) != 'c':
    print('pipe failed (2)')
...
# safeDivideDefault
if pamda.safeDivideDefault(5,2,1) != 0.5 or pamda.safeDivideDefault(5,0,1) != 0.2:
